...
class Randomizer:
    ...
    lavaenemies = [23] #only the statue is here for now because enemies not in lavapos (the egg carriers near the bonfire) can end up replaced for some reason as well and I don't want dragon butts
    ...
    def copyDarkrootGarden(self):
        ...
        EVENTID = {1200801}     #Moonlight Butterfly model/param fix
        for i in range(len(refMsb.parts[2].rows)):
