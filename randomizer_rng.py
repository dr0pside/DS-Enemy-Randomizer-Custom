...
class Randomizer:
    ...
    def GetNormalEnemy(self, diffmode, mapname, careAboutLimit, maxSize, desiredDifficulty, diffStrictness, originalEnemyID):
        ...
        @lavaProof          is lavaproof on or off
    ...
    def copyDarkrootGarden(self):
        ...
        EVENTID = {1200801}     #Moonlight Butterfly model/param fix (redundant but for some reason MLB gets replaced with a tree without these lines)
        for i in range(len(refMsb.parts[2].rows)):
            ...
            for inputIndex, inFile in enumerate(self.inputFiles):
                ...
                #Lavaproof enemy logic
                        ...
                        if (newChar >= 0):
                            ...
                            if (inFile == "m13_01_00_00" and creatureId == 'c5220_0000'): #pull nito boss model if nito is replaced
                                nitoModel = self.msbio.parts[2].rows[rowIndex][MODEL_DATA_COL]
                                
                            if (inFile == "m13_01_00_00" and creatureId == 'c5220_0001'): #assign nito boss model to the nito covenant NPC
                                try:
